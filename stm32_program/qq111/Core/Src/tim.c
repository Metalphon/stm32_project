...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = RB_C1_Pin|RB_C2_Pin;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC9     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = LF_C1_Pin|LF_C2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PC12     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = SC_C1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM15;
    HAL_GPIO_Init(SC_C1_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM23_MspPostInit 0 */
    ...
    PF2     ------> TIM23_CH3
    */
    GPIO_InitStruct.Pin = LB_C1_Pin|LB_C2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void set_PWM_DutyCycle(TIM_HandleTypeDef *htim, uint32_t channel, uint32_t dutyCycle)
{
    ...
    sConfigOC.OCMode = TIM_OCMODE_PWM1;
    sConfigOC.Pulse = (htim->Init.Period * dutyCycle) / 100;
    sConfigOC.OCPolarity = TIM_OCPOLARITY_HIGH;
    sConfigOC.OCFastMode = TIM_OCFAST_DISABLE;
