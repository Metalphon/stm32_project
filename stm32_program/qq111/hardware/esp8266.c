...
//{
//    HAL_UART_IRQHandler(&huart9); // 调用HAL库中的串口中断处理函数
//    
//    if (__HAL_UART_GET_FLAG(&huart9, UART_FLAG_RXNE) != RESET)
//    {
//        if (esp8266_cnt >= sizeof(esp8266_buf))	esp8266_cnt = 0; // 防止串口被刷爆
//        esp8266_buf[esp8266_cnt++] = huart9.Instance->DR;
//        

//        
//        __HAL_UART_CLEAR_FLAG(&huart9, UART_FLAG_RXNE);
//    }
//}
