...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = lf1_Pin|lf2_Pin|lb1_Pin|lb2_Pin;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC9     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = rf1_Pin|rf2_Pin|rb1_Pin|rb2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
Input   : Motor1L_PWM：Left wheel PWM；Motor1R_PWM：Right wheel PWM
brush: brush PWM; flag: 0->front  1->back  2->right  3->left
Output  : none
函数功能：赋值给PWM寄存器
入口参数：左轮PWM、右轮PWM
返回  值：无
**************************************************************************/
void Give_Motor_PWM(int Motor1L_PWM,int Motor1R_PWM,int brush,int flag)
{
	
//	TIM2->CCR1=Motor1R_PWM; 
	
//	   switch(flag)
//      {
//        case 0: 
//		//左正			
//		TIM2->CCR1=Motor1L_PWM; 
//		TIM2->CCR2=0;
//		TIM2->CCR3=Motor1L_PWM; 
//		TIM2->CCR4=0;
//    //右正
//		TIM3->CCR1=Motor1R_PWM; 
//		TIM3->CCR2=0;
//		TIM3->CCR3=Motor1R_PWM; 
//		TIM3->CCR4=0;
//				break;
//        case 1:
//		TIM2->CCR1=0; 
//		TIM2->CCR2=Motor1L_PWM;
//		TIM2->CCR3=0; 
//		TIM2->CCR4=Motor1L_PWM;

//		TIM3->CCR1=0; 
//		TIM3->CCR2=Motor1R_PWM;
//		TIM3->CCR3=0; 
//		TIM3->CCR4=Motor1R_PWM;
//				break; 
//        case 2:
...
// 	TIM23->CCR2=brush;
		...
		TIM23->CCR1=Motor1R_PWM; 
		TIM23->CCR2=0;
		TIM23->CCR3=Motor1R_PWM; 
		TIM23->CCR4=0;	
