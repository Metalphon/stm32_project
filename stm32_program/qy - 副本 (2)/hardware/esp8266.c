...
//	返回参数：	无
//
//	说明：		  HAL_UART_IRQHandler(&huart2);

//==========================================================
//void USART2_IRQHandler(void)
//{
//    HAL_UART_IRQHandler(&huart2); // 调用HAL库中的串口中断处理函数
//    
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
	if(huart == &huart2) // 判断是串口2发出的中断
	{
		...
		HAL_UART_Receive_IT(&huart2, &esp8266_data[0], 1); // 继续接收下一个字节
	}
}
